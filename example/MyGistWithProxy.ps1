...
$scripts = @(
    'https://raw.githubusercontent.com/patrickdobler/boxstarter/master/example/gist/MyGist.ps1'
)

# Download my boxstarter bootstrap
$webClient.DownloadFile('https://raw.githubusercontent.com/patrickdobler/boxstarter/master/boxstarter.ps1', "$($env:temp)\boxstarter.ps1")
